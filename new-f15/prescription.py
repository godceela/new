...
def submit_quiz():
    ...
    label3 = tk.Label(top, text="\u2714 Always remember to prioritize your health and well-being.")
    label3.pack(padx=1, pady=1)
        
    ok_button = tk.Button(top, text="Save and Exit", command=quit)
...
printBtn = tk.Button(root, text="Get Prescription", command=submit_quiz, 
                     bg="#b12a2a", fg="#ffffff") 
printBtn.config(font=("Microsoft JhengHei", 11),cursor="hand2")
printBtn.place(relx=0.75, rely=0.91, anchor=CENTER)
